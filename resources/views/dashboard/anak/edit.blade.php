...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  ...
  <div class="col-lg-8">
      ...
      <form method="post" action="/dashboard/anak/{{ $a->id }}  " class="mb-5" enctype="multipart/form-data">
        @csrf
        @method('put')
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="hidden" name="oldImage" value="{{ $a->image }}">
            <img src="{{ asset('storage/'. $a->image) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
